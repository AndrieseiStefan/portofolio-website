        ...
        <div className="services-container reveal grid grid-cols-1 gap-6 md:grid-cols-3">
          {featuredServices.map((service, index) => (
            ...
            >
              ...
              <p className="leading-relaxed text-ink/72 dark:text-zinc-400">{service.shortDescription}</p>
            </article>
          ))}
        </div>
        ...
        <div className="reveal relative mx-auto mt-16 max-w-3xl">
          ...
          <div className="relative rotate-2 overflow-hidden rounded-xl border border-ink/12 bg-[#f8f3eb] p-6 shadow-2xl transition-transform duration-500 hover:rotate-0 dark:border-white/10 dark:bg-[#09090B]">
            ...
            <div className="space-y-4">
              ...
              <div className="flex h-20 items-center justify-center rounded-lg border border-ink/12 bg-ink/[0.045] dark:border-white/5 dark:bg-white/5">
