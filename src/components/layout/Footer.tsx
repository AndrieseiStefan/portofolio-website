...
export function Footer() {
  return (
    <footer className="border-t border-ink/12 bg-[#f1e8dc] dark:border-white/5 dark:bg-[#09090B]">
      <Container className="py-8">
        <div className="flex flex-col items-center justify-between gap-4 text-sm text-ink/75 dark:text-zinc-400 md:flex-row">
